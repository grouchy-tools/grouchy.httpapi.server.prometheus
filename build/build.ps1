properties {
   ...
   $ProjectPath = "$SrcPath\Grouchy.HttpApi.Server.Prometheus\Grouchy.HttpApi.Server.Prometheus.csproj"
#   $TestProjectPath = "$SrcPath\Grouchy.HttpApi.Server.Prometheus.Tests\Grouchy.HttpApi.Server.Prometheus.Tests.csproj"
